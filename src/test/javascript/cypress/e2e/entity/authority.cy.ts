...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '0521bfb0-ab04-4ea1-bbdb-baf6a86e270f' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('2cf94bbe-2a4e-47c3-9f2c-bebbda04b5ef');
      cy.get(`[data-cy="name"]`).should('have.value', '2cf94bbe-2a4e-47c3-9f2c-bebbda04b5ef');
